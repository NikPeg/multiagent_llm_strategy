...
\begin{thesis}[
    ...
    year = 2025,
    %
    authorGroup = мИПИИ241,
    authorName = Н. С. Пеганов,
    %
    academicTeacherTitle = {доцент департамента программной инженерии факультета компьютерных наук, канд. техн. наук},
    ...
    \setConclusionResource{parts/ch5-conclusion}

    \addAppendix{Приложение А: Custdev потенциальных пользователей}{parts/appendix-example-1}
    \addAppendix{Приложение Б: Опрос пользователей прототипа}{parts/appendix-example-2}
    \addAppendix{Приложение В: Сравнительный анализ языковых моделей}{parts/appendix-example-3}
