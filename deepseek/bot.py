...
async def handle_country_desc(message: types.Message, user_id: int, user_text: str):
    ...
    aspect_prompts = [
        ("экономика", "Состояние экономики страны (доходы, расходы, ресурсы в казне):"),
        ("военное_дело", "Военная организация, численность армии и оборона страны:"),
        ("внеш_политика", "Внешняя политика страны, отношения с соседями:"),
        ("территория", "Территория, география, природные особенности страны:"),
        ("технологичность", "Уровень развития технологий в стране:"),
        ("религия_культура", "Религия, культура, искусство, традиции страны:"),
        ("управление", "Система управления, государственный строй, законы страны:"),
        ("стройка", "Инфраструктура, развитие строительства, важные объекты:"),
