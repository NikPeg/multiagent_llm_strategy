...
ASPECT_SYNONYMS = {
    "экономика": ["экономик", "торгов", "богатств", "финанс", "ресурс", "бюджет", "деньги", "доход", "налог"],
    "военное_дело": ["армия", "войско", "воен", "солдат", "боеспособн", "сражен", "защит", "оборона", "война", "войн"],
    "внеш_политика": [
        "внешн",
        "политик",
        "сосед",
    ...
    "стройка": ["строит", "инфраструктур", "дорог", "здания", "дворец", "город", "построй", "объект", "ремонт"],
    "общество": [
        "обществ",
        "класс",
        "слой",
